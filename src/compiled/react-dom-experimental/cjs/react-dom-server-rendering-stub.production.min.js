...
var f = {usingClientEntryPoint: !1, Events: null, Dispatcher: {current: null}};
function h(b) {
  for (
...
exports.preinit = function (b, a) {
  ...
  if (c && 'string' === typeof b && a && 'string' === typeof a.as) {
    let d = a.as;
    let g = k(d, a.crossOrigin);
    let p = 'string' === typeof a.integrity ? a.integrity : void 0;
    let q = 'string' === typeof a.fetchPriority ? a.fetchPriority : void 0;
    'style' === d
      ? c.preinitStyle(
          b,
